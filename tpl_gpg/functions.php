 ...
 */
function orbisius_ct_gpg_child_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ct_gpg_child_parent_style';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_gpg_child_child_theme_enqueue_styles',10 );

require ('inc/rewrite_php.php');
require ('inc/enqueue.php');
require ('inc/send-data.php');
require ('inc/ajax.php');
require ('inc/theme-support.php');
require ('inc/custom_cpt.php');

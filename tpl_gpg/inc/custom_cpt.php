...
function renommer_projets_divi() {
  ...
  register_post_type( 'project',
      ...
      'rewrite' => array( 'slug' => 'monument', 'with_front' => true ),
      'supports' => array(),
  ...
  register_post_type( 'granits',
  array( 
	  'labels' => array(
		'name' => __( 'Granits', 'gpg' ),
		'singular_name' => __( 'Granit', 'gpg' ),
		"all_items" => __( "Tous les Granits", "gpg" ),
					"add_new" => __( "Ajouter", "gpg" ),
					"add_new_item" => __( "Ajouter un nouveau granit", "gpg" ),
					"edit_item" => __( "Modifier le Granit", "gpg" ),
					"new_item" => __( "Nouveau Granit", "gpg" ),
					"view_item" => __( "Voir le Granit", "gpg" ),
					"view_items" => __( "Voir les granits", "gpg" ),
					"search_items" => __( "rechercher des Granit", "gpg" ),
					"not_found" => __( "Aucune Granit trouvé", "gpg" ),
					"not_found_in_trash" => __( "Aucune Granit trouvé dans la corbeille", "gpg" ),
					"parent" => __( "Parent Granit:", "gpg" ),
					"featured_image" => __( "Featured image for this Granit", "gpg" ),
					"set_featured_image" => __( "Set featured image for this Granit", "gpg" ),
					"remove_featured_image" => __( "Remove featured image for this Granit", "gpg" ),
					"use_featured_image" => __( "Use as featured image for this Granit", "gpg" ),
					"archives" => __( "Granit archives", "gpg" ),
					"insert_into_item" => __( "Insert into Granit", "gpg" ),
					"uploaded_to_this_item" => __( "Upload to this Granit", "gpg" ),
					"filter_items_list" => __( "Filter Granit list", "gpg" ),
					"items_list_navigation" => __( "Granit list navigation", "gpg" ),
					"items_list" => __( "Granit list", "gpg" ),
					"attributes" => __( "Granit attributes", "gpg" ),
					"name_admin_bar" => __( "Granit", "gpg" ),
					"item_published" => __( "Granit published", "gpg" ),
					"item_published_privately" => __( "Granit published privately.", "gpg" ),
					"item_reverted_to_draft" => __( "Granit reverted to draft.", "gpg" ),
					"item_scheduled" => __( "Granit scheduled", "gpg" ),
					"item_updated" => __( "Granit updated.", "gpg" ),
					"parent_item_colon" => __( "Parent Granit:", "gpg" ),

  ),
  'has_archive' => true,
  'hierarchical' => false,
  'public' => true,
  'show_in_rest' => false, // Disponible dans l'API
  'rewrite' => array( 'slug' => 'granits', 'with_front' => true ),
  'supports' => array(),
  'menu_icon' => 'dashicons-category',
  "description" => "",
		"publicly_queryable" => true,
...
function cptui_register_my_granit_couleur() {

	/**
	 * Taxonomy: Couleur Granit.
	 */
	...
	$args = [
		...
		"show_in_nav_menus" => true,
		"query_var" => true,
		"rewrite" => [ 'slug' => 'couleur_granit', 'with_front' => true, ],
		"show_admin_column" => false,
		"show_in_rest" => true,
		"show_tagcloud" => true,
		"rest_base" => "couleur_granit",
		"rest_controller_class" => "WP_REST_Terms_Controller",
		"show_in_quick_edit" => false,
		"show_in_graphql" => false,
	];
	register_taxonomy( "couleur_granit", [ "granits" ], $args );
}
add_action( 'init', 'cptui_register_my_granit_couleur' );

function cptui_register_my_granit_provenance() {

	/**
	 * Taxonomy: Provenance Granit.
	 */

	$labels = [
		"name" => __( "Provenance", "gpg" ),
		"singular_name" => __( "Couleur", "gpg" ),
	];

	
	$args = [
		"label" => __( "Provenance", "gpg" ),
		"labels" => $labels,
		"public" => true,
		"publicly_queryable" => true,
		"hierarchical" => true,
		...
		"show_in_nav_menus" => true,
		"query_var" => true,
		"rewrite" => [ 'slug' => 'provenance_granit', 'with_front' => true, ],
		"show_admin_column" => false,
		"show_in_rest" => true,
		"show_tagcloud" => true,
		"rest_base" => "provenance_granit",
		"rest_controller_class" => "WP_REST_Terms_Controller",
		"show_in_quick_edit" => false,
		"show_in_graphql" => false,
	];
	register_taxonomy( "provenance_granit", [ "granits" ], $args );
}
add_action( 'init', 'cptui_register_my_granit_provenance' );

function cptui_register_my_granit_qualite_funeraire() {

	/**
	 * Taxonomy: Durabilite Granit.
	 */

	$labels = [
		"name" => __( "Qualité funéraire", "gpg" ),
		"singular_name" => __( "Qualité funéraire", "gpg" ),
	];

	
	$args = [
		"label" => __( "Qualité funéraire", "gpg" ),
		"labels" => $labels,
		"public" => true,
		"publicly_queryable" => true,
		"hierarchical" => true,
		...
		"show_in_nav_menus" => true,
		"query_var" => true,
		"rewrite" => [ 'slug' => 'qualite_funeraire', 'with_front' => true, ],
		"show_admin_column" => false,
		"show_in_rest" => true,
		"show_tagcloud" => true,
		"rest_base" => "qualite_funeraire",
		"rest_controller_class" => "WP_REST_Terms_Controller",
		"show_in_quick_edit" => false,
		"show_in_graphql" => false,
	];
	register_taxonomy( "qualite_funeraire", [ "granits" ], $args );
}
add_action( 'init', 'cptui_register_my_granit_qualite_funeraire' );
...
function cptui_register_my_taxes() {
	...
	$labels = [
		"name" => __( "Gammes", "custom-post-type-ui" ),
		"singular_name" => __( "Gamme", "custom-post-type-ui" ),
	];

	
	$args = [
		"label" => __( "Gammes", "custom-post-type-ui" ),
		"labels" => $labels,
		"public" => true,
		"publicly_queryable" => true,
		"hierarchical" => true,
